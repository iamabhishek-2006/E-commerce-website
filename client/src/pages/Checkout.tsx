...
import NewAddress from "@/dailogs/NewAddress";
  ...
  return (
    <div className="p-3 max-w-2xl mx-auto ">
      ...
      <div className="flex gap-2 flex-col">
        ...
        {addresses?.length === 0 && (
          <p className="text-sm italic">No address found</p>
        )}
        <div className="flex gap-2 flex-col">
            ...
            {addresses?.map((address: IAddress) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm">  Landmark:{" "}
                    <span className="italic text-[12px] text-gray-700">
                      {address.landmark}
                    </span>
                  </p>
                  <p className="text-sm">
      ...
      <div className="flex gap-2 flex-col">
        ...
        <div className="flex flex-col gap-2">
          {cart?.map((item) => (
            <Card
              key={item.item._id}
              className="p-2 flex flex-row justify-between gap-2 w-full"
            >
              <div>
                <img
              ...
              <div className="flex gap-2 items-center">
                <h1 className="font-semibold">₹{item.item.price}</h1>x
