...
const Dialog = ({ addProduct, open, onClose, categories }) => {
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <select name="category" value={formState.category} onChange={handleChange} className="w-full rounded border text-sm border-gray-300 p-1">
